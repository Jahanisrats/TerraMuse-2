            ...
            <div aria-modal="true" className="fixed inset-0 z-[60] flex justify-end" role="dialog">
                ...
                <aside className="relative w-full max-w-[500px] h-full bg-background-light shadow-2xl flex flex-col transform transition-transform border-l border-[#eaddcf] bg-paper-texture animate-fadeIn">
                    <div className="px-8 py-6 border-b border-text-main/10 flex items-center justify-between bg-white/40 backdrop-blur-md sticky top-0 z-10">
                        <h2 className="font-serif text-2xl font-light text-text-main">Your Cart <span className="text-base text-text-sub font-display ml-2">(1)</span></h2>
                                ...
                                <div className="flex-1 flex flex-col justify-between py-1">
                                    <div>
                                        <div className="flex justify-between items-start gap-4">
                                            ...
                                            <span className="font-medium text-text-main font-serif italic">$128.00</span>
                                        </div>
                                    ...
                                    <div className="flex items-end justify-between mt-4">
                                        <div className="flex items-center border border-text-main/20 rounded-full px-1 py-1 gap-1 bg-white/40">
                                            <button className="size-7 flex items-center justify-center text-text-main hover:text-primary transition-colors rounded-full hover:bg-white/50">
                                        ...
                                        <button className="text-xs uppercase tracking-widest text-text-sub/70 hover:text-primary border-b border-transparent hover:border-primary transition-colors pb-0.5">Remove</button>
                                    </div>
                                </div>
                            </div>
                        </div>
