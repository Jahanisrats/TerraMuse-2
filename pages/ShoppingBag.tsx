    ...
    <main className="flex-grow relative px-6 lg:px-12 py-10 lg:py-16">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            <div className="mb-12 flex items-baseline gap-4 border-b border-text-main/10 pb-6">
                ...
                <span className="text-xl text-text-sub font-light">(2 items)</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                <div className="lg:col-span-8 flex flex-col gap-0">
                    {/* Item 1 */}
                    <div className="group py-8 first:pt-0 border-b border-text-main/10 relative animate-fadeIn">
                        <div className="flex flex-col sm:flex-row gap-6 lg:gap-8">
                            <div className="w-full sm:w-40 lg:w-48 aspect-[3/4] bg-[#f0ece6] rounded-xl overflow-hidden relative shadow-sm">
                                <img alt="Canyon Silk Shirt in Terracotta" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDjigXpglYo4leeMTu45JnJkXx1nU7aJ7aUJaK5Vls2fysIVGtOYNRfMNV8VXiQ1ihTdUwvRZ5lDgtW8FvbPBX_vVJdvj7bbHDa7EZ5luhhWn04fvDCuFcGcyLUxT0fti3ZyV5hMgMiDJ6y-0b8iShRwhJLgaxudU9NJCTrxfIML9RAFHhh4993OmrPc_GTpk_UKfiRw_MfNTepMM3BhuURPqBPoEyY83NR6_AOCBLi_5BJ9WlBUBpLPyDwcb6GET8T2R6YZnaPSE4"/>
                            </div>
                            <div className="flex-1 flex flex-col justify-between py-1">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-start">
                                        <h3 className="text-2xl font-serif text-text-main">Canyon Silk Shirt</h3>
                                        <span className="text-lg font-medium text-text-main">$185.00</span>
                                    </div>
                                    <p className="text-text-sub text-sm tracking-wide">Terracotta / Medium</p>
                                    <p className="text-text-sub/80 text-xs mt-1">Ships in 2-3 business days</p>
                                </div>
                                <div className="flex justify-between items-center mt-6 sm:mt-0">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex items-center border border-text-main/20 rounded-full h-10 px-1">
                                            <button className="w-8 h-full flex items-center justify-center text-text-sub hover:text-primary transition-colors hover:bg-black/5 rounded-full">
                                                <span className="material-symbols-outlined text-[16px]">remove</span>
                                            </button>
                                            <span className="w-8 text-center text-sm font-medium text-text-main">1</span>
                                            <button className="w-8 h-full flex items-center justify-center text-text-sub hover:text-primary transition-colors hover:bg-black/5 rounded-full">
                                                <span className="material-symbols-outlined text-[16px]">add</span>
                                            </button>
                                        </div>
                                    </div>
                                    <button className="font-serif italic text-text-sub hover:text-primary transition-colors text-lg decoration-1 underline-offset-4 hover:underline">
                                        Remove
                                    </button>
                                </div>
                            </div>
                    ...
                    {/* Item 2 */}
                    <div className="group py-8 border-b border-text-main/10 relative animate-fadeIn" style={{ animationDelay: '0.1s' }}>
                        <div className="flex flex-col sm:flex-row gap-6 lg:gap-8">
                            <div className="w-full sm:w-40 lg:w-48 aspect-[3/4] bg-[#EAE4DD] rounded-xl overflow-hidden relative shadow-sm flex items-center justify-center">
                                <img alt="Woven Artisan Tote" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out opacity-90 mix-blend-multiply" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWFa0qBMX5heg1scwaALKhXqJ9FmK7j9yB9L8roxwD1GjWuT73lWEcUAN5wTMqQzFseNnZ0NW4pjBr5l4hOHvSocpdBLEPC_RgCQM_kstUZq1UrBOlTgcVLqKkaAW6XMUlDok1ETFoUQPZfSGbBGLUQvsG-x-yQ5vZER9fGRDYfZv7PAFd0hwP7pn4IY469vkSnY5nwM4mOHHmvIOPlwYg4EOMDsrzfAPb0CVGrIYC6IWDwq2VpJxqIA9CkgcX8m3FioKGp4vlHuA"/>
                            </div>
                            <div className="flex-1 flex flex-col justify-between py-1">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-start">
                                        <h3 className="text-2xl font-serif text-text-main">Woven Artisan Tote</h3>
                                        <span className="text-lg font-medium text-text-main">$125.00</span>
                                    </div>
                                    <p className="text-text-sub text-sm tracking-wide">Natural Straw / One Size</p>
                                    <p className="text-text-sub/80 text-xs mt-1">Handmade: Allow 5 days processing</p>
                                </div>
                                <div className="flex justify-between items-center mt-6 sm:mt-0">
                                    <div className="flex items-center gap-3">
                                        <span className="text-sm text-text-sub mr-2">Qty</span>
                    ...
                    <div className="bg-[#f4efe9] rounded-[2rem] p-8 lg:p-10 sticky top-28 shadow-xl shadow-[#6B3E2D]/5 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
                        ...
                        <div className="space-y-4 text-text-main/80 pb-6 border-b border-text-main/10">
                            <div className="flex justify-between text-sm">
                                <span>Subtotal</span>
                                <span className="font-medium">$310.00</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span>Shipping</span>
                        ...
                        <div className="flex justify-between items-center py-6">
                            ...
                            <span className="text-xl font-serif font-bold text-text-main">$310.00</span>
                        </div>
